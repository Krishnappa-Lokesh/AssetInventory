sap.ui.define([
	...
	return BaseObject.extend("assetinv.AssetInventory.model.GroupSortState", {
		 ...
		 * @class
		 * @public
		 * @alias assetinv.AssetInventory.model.GroupSortState
		 */
		...
		group: function (sKey) {
			...
			if (sKey === "") {
				...
				this._oViewModel.setProperty("/sortBy", "Txt50");
			}
