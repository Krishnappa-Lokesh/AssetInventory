sap.ui.define([
	"assetinv/AssetInventory/model/GroupSortState",
	...
	QUnit.test("Should always return a sorter when sorting", function (assert) {
		...
		assert.strictEqual(this.oGroupSortState.sort("Txt50").length, 1, "The sorting by Txt50 returned a sorter");
	});
	...
	QUnit.test("Should set the grouping to None if the user sorts by Txt50 and there was a grouping before", function (assert) {
		// Arrange
		this.oModel.setProperty("/groupBy", "");

		this.oGroupSortState.sort("Txt50");
