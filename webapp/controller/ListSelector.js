sap.ui.define([
	...
	return BaseObject.extend("assetinv.AssetInventory.model.ListSelector", {
		 ...
		 * @class
		 * @public
		 * @alias assetinv.AssetInventory.model.ListSelector
		 */
		 ...
		 * @return {assetinv.AssetInventory.model.ListSelector} the list selector object for method chaining
		 * @public
		 */
