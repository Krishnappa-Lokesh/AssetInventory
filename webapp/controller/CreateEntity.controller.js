sap.ui.define([
	...
	return BaseController.extend("assetinv.AssetInventory.controller.CreateEntity", {
		...
		onInit: function () {
			var that = this;
			this.getRouter().getTargets().getTarget("change").attachDisplay(null, this._onDisplay, this);
		...
		_onCreate: function (oEvent) {
			...
			var oContext = this._oODataModel.createEntry("assetSet", {
		...
		_fnUpdateSuccess: function () {
			...
			this.byId("statusAccepted").setVisible(true);
...
*/		
		...
		_fnEntityCreated: function (oData) {
			var sObjectPath = this.getModel().createKey("assetSet", oData);
